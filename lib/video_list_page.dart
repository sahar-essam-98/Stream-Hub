...
class VideoListPage extends StatefulWidget {
  late List videoList;
  VideoListPage({required this.videoList});
    ...
    return Positioned(
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            Text("sahar",style: TextStyle(color: Colors.blue,fontSize: 14),),
            Positioned(
              right: 65,
                child: Image.asset('assets/images/at.webp',color:  Colors.red,width: 28,height: 28,),
            ),
            Positioned(
              right: 16,
              child: Image.asset('assets/images/smile.webp',color:  Colors.red,width: 45,height: 45,),
            )
          ],
        ),
      ),
