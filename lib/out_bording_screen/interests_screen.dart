...
class _InterestsScreenState extends State<InterestsScreen> {
  final List _tags = <String>['Comedy', 'Dance', 'Learning', 'Life style', 'Food', 'Sports', 'Entertainment', 'Fitness & Health', 'Makeup'];
                ...
                children: _tags
                    .map(
                      (tag) => Chip(
                        ...
                        elevation: 4,
                        label: Text(tag),
                        labelStyle: TextStyle(fontWeight: FontWeight.w400, color: color1, fontSize: 12.sp, fontFamily: 'poppins'),
